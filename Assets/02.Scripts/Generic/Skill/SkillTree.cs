...
public class SkillNode
{
    ...
    public SkillNode(string id, string name, object skill, Vector2 position, string skillSeries, int skillLevel, List<string> requiredSillds = null)
    {
        Id = id;
        Name = name;
        Skill = skill;
        ...
        RequiredSkillds = requiredSillds ?? new List<string>();
        isUnlocked = false;
    }
}
