...
public class BattleSystem : MonoBehaviour
{
    ...
    void Start()
    {
        //캐릭터들을 속도 수능로 정렬하여 턴 순서 초기화(내림차순)
    ...
    {
        Vector3 screePos = Camera.main.WorldToScreenPoint(position);
        GameObject damageObj = Instantiate(damageTextPrefab, screePos, Quaternion.identity, uiCanvas.transform);
