...
namespace MyGame.QuestSystem
{
    public class Quest
    {
        ...
        private List<string> prerequisiteQuestIds;          //선행 퀘스트 ID목록
        ...
        public void AddCondition(IQuestCondition condition) //퀘스트에 완료 조건ㅇ르 추가하는 메서드
        {
        ...
        public void Start()                             //퀘스트 시작하는 메서드
        {
        ...
        public bool CheckCompletion()                       //퀘스트 완료조건을 검사하는 메서드
        {
